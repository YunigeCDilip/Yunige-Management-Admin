            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="{{route('admin.items.create')}}" class="btn btn-danger waves-effect waves-light" ><i class="mdi mdi-plus-circle mr-1"></i> {{__('messages.add_new')}}</a>
                        </div>
                    </div><!-- end col-->
                </div>
                    ...
                    <table class="table table-centered table-hover mb-0" id="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>{{__('messages.barcode_entry_date')}}</th>
                                <th>{{__('messages.brand_r')}}</th>
