            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="{{route('admin.amazon-progress.create')}}" class="btn btn-danger waves-effect waves-light" ><i class="mdi mdi-plus-circle mr-1"></i> {{__('messages.add_new_amazon_progress')}}</a>
                        </div>
                    </div><!-- end col-->
                </div>
                    ...
                    <table class="table table-centered table-hover mb-0" id="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th style="width: 400px !important;">{{__('messages.memo')}}</th>
