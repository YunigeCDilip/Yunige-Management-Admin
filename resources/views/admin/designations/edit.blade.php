<div id="edit-custom-modal" class="modal-demo">
    ...
    <h4 class="custom-modal-title">{{__('messages.edit_designation')}}</h4>
    <div class="custom-modal-text text-left">
        <form id="editForm" method="post" class="needs-validation" novalidate>
            ...
            <div class="text-right">
                <button type="button" class="btn btn-success waves-effect waves-light update-designation">{{__('actions.save')}}</button>
