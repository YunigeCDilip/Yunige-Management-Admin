                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right">
                            <a href="#custom-modal" class="btn btn-danger waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> {{__('messages.add_new_designation')}}</a>
                        </div>
                    </div><!-- end col-->
                </div>
...
@section('additional-content')
    @include('admin.designations.add')
    @include('admin.designations.edit')
@endsection
@endsection
