                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="text-lg-right">
                            <a href="#custom-modal" class="btn btn-danger waves-effect waves-light" data-animation="fadein" data-plugin="custommodal" data-overlaycolor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> {{__('messages.add_new_shipper')}}</a>
                        </div>
                    </div><!-- end col-->
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover mb-0" id="table">
                        <thead class="thead-light">
                            <tr>
                                <th>{{__('messages.shipper_name')}}</th>
...
@section('additional-content')
    @include('admin.master.clients.shipper.add')
    @include('admin.master.clients.shipper.edit')
@endsection
@endsection
@section('additional-js')
    ...
    <script src="{{asset('admin/custom/js/shipper.js')}}"></script>
@endsection