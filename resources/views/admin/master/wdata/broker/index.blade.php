            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="{{route('admin.custom-brokers.create')}}" class="btn btn-danger waves-effect waves-light" ><i class="mdi mdi-plus-circle mr-1"></i> {{__('messages.add_new')}}</a>
                        </div>
                    </div><!-- end col-->
                </div>
                    ...
                    <table class="table table-centered table-hover mb-0" id="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th style="width: 250px;">{{__('messages.wdata_3')}}</th>
                                <th>{{__('messages.email')}}</th>
                                <th>{{__('messages.telephone_no')}}</th>
                                <th>{{__('messages.fax_number')}}</th>
