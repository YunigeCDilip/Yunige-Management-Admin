...
class MigrateAirtableOutbounds extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($data as $item){
            $check = Outbound::where('airtable_id', $item['id'])->first();
            if(!$check){
                ...
                $outbound->warehouse_in_charge = (isset($item['fields']['担当倉庫'])) ? json_decode($item['fields']['担当倉庫'], true) : null;
                $outbound->ship_date = (isset($item['fields']['出荷日'])) ? date('Y-m-d', strtotime($item['fields']['出荷日'])) : null;
                $outbound->create_date = (isset($item['fields']['CreateDate'])) ? date('Y-m-d', strtotime($item['fields']['CreateDate'])) : null;
                $outbound->estimited_ship_date = (isset($item['fields']['出荷予定日'])) ? date('Y-m-d', strtotime($item['fields']['出荷予定日'])) : null;
                ...
                $outbound->fba_entry_date = (isset($item['fields']['FBA搬入指定入日'])) ? date('Y-m-d', strtotime($item['fields']['FBA搬入指定入日'])) : null;
                ...
                $outbound->url = (isset($item['fields']['URL1'])) ? $item['fields']['URL1'] : null;
                $outbound->next_url = (isset($item['fields']['URL2'])) ? $item['fields']['URL2'] : null;
                ...
                $outbound->wait_date_create_modify = (isset($item['fields']['WaitDateCreate-modify'])) ? date('Y-m-d', strtotime($item['fields']['WaitDateCreate-modify'])) : null;
