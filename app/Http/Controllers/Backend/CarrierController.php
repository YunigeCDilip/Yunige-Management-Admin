...
use App\Application\Services\CarrierService;
...
class CarrierController extends Controller 
{
    ...
    {
        if(!$request->ajax()){
            $data['title'] = trans('messages.wdata_carriers');
            $data['menu'] = trans('messages.wdata_carriers');
            $data['subMenu'] = trans('actions.lists');

            return view('admin.master.wdata.carrier.index', $data);
        }
     ...
     *
     * @param UpdateCarrierRequest $request
     * @param $cat
     * @return Response
     */
    public function update(UpdateCarrierRequest $request, $cat)
    {
