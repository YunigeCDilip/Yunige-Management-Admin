...
jQuery(document).ready(function(){
    ...
    $('table#table').delegate('.mdi-square-edit-outline', 'click', function(e){
        ...
        $.get(baseUrl+"wdata-status/"+shipperId, function(data){
    ...
    $('.update-shipper').on('click', function(e){
        ...
        $.ajax({
            type: "PUT",
            url: baseUrl + "wdata-status/"+$('form#editForm').find('input[name="shipper_id"]').val(),
            data: form_data,
            success: function (data) {
...
$('table#table').delegate('.mdi-delete', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'wdata-status/' + userId,
                type: 'post',
