...
jQuery(document).ready(function(){
    ...
    $('table#table').delegate('.mdi-square-edit-outline', 'click', function(e){
        ...
        $.get(baseUrl+"item-categories/"+shipperId, function(data){
            var form = $('form#editForm');
            if(data.status){
                form.find('input[name="category_id"]').val(shipperId);
    ...
    $('.update-shipper').on('click', function(e){
        ...
        $.ajax({
            type: "PUT",
            url: baseUrl + "item-categories/"+$('form#editForm').find('input[name="category_id"]').val(),
            data: form_data,
            success: function (data) {
...
$('table#table').delegate('.mdi-delete', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'item-categories/' + userId,
                type: 'post',
