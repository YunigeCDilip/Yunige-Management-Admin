...
jQuery(document).ready(function(){
    ...
    $('table#table').delegate('.mdi-square-edit-outline', 'click', function(e){
        ...
        $.get(baseUrl+"product-types/"+shipperId, function(data){
    ...
    $('.update-shipper').on('click', function(e){
        ...
        $.ajax({
            type: "PUT",
            url: baseUrl + "product-types/"+$('form#editForm').find('input[name="category_id"]').val(),
            data: form_data,
            success: function (data) {
...
$('table#table').delegate('.mdi-delete', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'product-types/' + userId,
                type: 'post',
