...
jQuery(document).ready(function(){
    ...
    $('table#table').delegate('.mdi-square-edit-outline', 'click', function(e){
        ...
        $.get(baseUrl+"wdata-categories/"+catId, function(data){
    ...
    $('.update-cat').on('click', function(e){
        ...
        $.ajax({
            type: "PUT",
            url: baseUrl + "wdata-categories/"+$('form#editForm').find('input[name="category_id"]').val(),
            data: form_data,
            success: function (data) {
...
$('table#table').delegate('.mdi-delete', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'wdata-categories/' + userId,
                type: 'post',
...
$('table#table').delegate('.activate', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'wdata-categories/activate',
                type: 'post',
