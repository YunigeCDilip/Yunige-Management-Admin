...
$(function(){
    $('.cancel-designation').on('click', function(e){
        e.preventDefault();
...
jQuery(document).ready(function(){
    ...
    $('.save-designation').on('click', function(e){
        e.preventDefault(); 
    ...
    $('table#table').delegate('.mdi-square-edit-outline', 'click', function(e){
        ...
        $.get(baseUrl+"designations/"+designationId, function(data){
    ...
    $('.update-designation').on('click', function(e){
        ...
        $.ajax({
            type: "PUT",
            url: baseUrl + "designations/"+$('form#editForm').find('input[name="designation_id"]').val(),
            data: form_data,
            success: function (data) {
...
$('table#table').delegate('.mdi-delete', 'click', function(e){
    ...
    swal({
        ...
        if(isConfirm){
            $.ajax({
                url: baseUrl + 'designations/' + userId,
                type: 'post',
